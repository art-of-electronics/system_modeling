...
class InputParams:
    ...
    font_size: int = 10
    title = f"Dadras\np={p:.1f}, o={o:.1f}, r={r:.1f}, c={c:.1f}, e={e:.1f}"


def dadras(state, __time__):
    x, y, z = state
    return y - InputParams.p * x + InputParams.o * y * z, \
        InputParams.r * y - x * z + z, \
        InputParams.c * x * y - InputParams.e * z


if __name__ == '__main__':
    ModelOutput = odeint(dadras, InputParams.init, InputParams.time_vector)
    ...
    plt.savefig("Dadras_1.png", bbox_inches='tight', dpi=200)
    ...
    plt.tight_layout()
    plt.savefig("Dadras_2.png", bbox_inches='tight', dpi=200)
