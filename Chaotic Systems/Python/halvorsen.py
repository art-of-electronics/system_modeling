...
def halvorsen(state, __time__):
    x, y, z = state
    return -InputParams.a * x - 4 * (y + z) - y ** 2, \
           -InputParams.a * y - 4 * (z + x) - z ** 2, \
           -InputParams.a * z - 4 * (x + y) - x ** 2


if __name__ == '__main__':

    ModelOutput = odeint(halvorsen, InputParams.init, InputParams.time_vector)
    ...
    plt.savefig("Halvorsen_1.png", bbox_inches='tight', dpi=200)
    ...
    plt.tight_layout()
    plt.savefig("Halvorsen_2.png", bbox_inches='tight', dpi=200)
